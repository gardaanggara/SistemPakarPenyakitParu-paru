$(document).ready(function () {
    var gejalaList = new Tabulator("#gejala-list", {
        columns: [
            { 
                title: "Aksi",
                field: "aksi",
    ...
    $("#gejala-list").on("click", ".edit-btn", function () {
        var id = $(this).data("id");
        console.log("Edit ID: " + id);
        // Ambil data 
        $.ajax({
            url: '/gejala/api/data/' + id,
            method: 'GET',
            success: function (data) {
                // Memasukkan data ke dalam modal
                $("#editId").val(data.id); 
                $("#editNama_gejala").val(data.nama_gejala); 
    ...
    $("#gejala-list").on("click", ".delete-btn", function () {
        var id = $(this).data("id");
